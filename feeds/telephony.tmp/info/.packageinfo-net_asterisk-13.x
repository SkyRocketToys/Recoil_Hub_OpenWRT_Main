...
Section: net
Category: Network
Title: Complete open source PBX, v13.15.0
Maintainer: Jiri Slachta <jiri@slachta.eu>
Source: asterisk-13.15.0.tar.gz
License: GPL-2.0
...
Submenu: Telephony
Version: 13.15.0-1
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk13 +PACKAGE_asterisk13-app-speech:asterisk13-res-speech
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: libxml2/host
...
Package: asterisk13-chan-lantiq
Submenu: Telephony
Version: 13.15.0-1
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk13 @TARGET_lantiq +PACKAGE_asterisk13-chan-lantiq:kmod-ltq-vmmc
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: libxml2/host

#-----------------------------------------------------------------------------
# update-custom-feed-FirmwareGameServer.sh
#
# Description:
...
SOURCE_GAME_SERVER=${1:-~/openwrt/custom-feed/recoil/src}
TARGET_GAME_SERVER=${2:-/media/Documents/Programming/C#/Unity_Projects/hotgen/Recoil/BaseStation/FirmwareGameServer/custom-feed/recoil/src}

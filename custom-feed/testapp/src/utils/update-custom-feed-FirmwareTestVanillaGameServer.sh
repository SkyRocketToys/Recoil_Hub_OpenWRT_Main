#-----------------------------------------------------------------------------
# update-custom-feed-FirmwareTestVanillaGameServer.sh
#
# Description:
...
SOURCE_GAME_SERVER=${1:-~/RecoilOpenWRT/custom-feed/testapp/src}
TARGET_GAME_SERVER=${2:-/media/Documents/Programming/C#/Unity_Projects/hotgen/Recoil/BaseStation/FirmwareTestVanillaGameServer/custom-feed/testapp/src}
